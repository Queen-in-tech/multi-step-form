...
const SideBar = () => {
  ...
  return (
    <div className="bg-[url('bg-sidebar-mobile.svg')] w-screen h-[23vh] justify-center items-start md:bg-[url('bg-sidebar-desktop.svg')] bg-cover bg-center bg-no-repeat md:h-[95vh] md:w-[23vw] py-10 px-8 md:my-4 md:ml-4 md:rounded-xl flex md:flex-col gap-5 md:gap-7 md:justify-normal">
