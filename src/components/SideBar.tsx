...
const SideBar = () => {
  ...
  return (
    <div className="bg-[url('../public/bg-sidebar-mobile.svg')] w-screen h-[23vh] justify-center items-start md:bg-[url('../public/bg-sidebar-desktop.svg')] bg-cover bg-center bg-no-repeat md:h-[95vh] md:w-[23vw] py-10 px-8 md:my-4 md:ml-4 md:rounded-xl flex md:flex-col gap-5 md:gap-7 md:justify-normal">
      <div className="flex gap-4 justify-start items-center">
      <p className={`font-bold h-10 w-10 text-center rounded-full ${location.pathname === "/" ? "text-black py-2 bg-[#bde1fc]" : "text-white border-2 py-1 border-blue-200"}`}>1</p>
